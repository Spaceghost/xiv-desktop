...
/// <summary>
/// Turns an app into the ghostty-dalamud command line posted over GhosttyDalamud.v1.Post
/// (a /term command without the "/term " prefix).
/// </summary>
public static class LaunchPlan
{
    ...
    /// <summary>
    /// The Post line for <paramref name="app"/>, or an error. Terminal=true apps are refused in v0: "window pull
    ...
    /// </summary>
    public static (string? Line, string? Error) For(AppInfo app)
    {
        if (app.Terminal)
        ...
        return (RunPrefix + app.Command, null);
    }
}
